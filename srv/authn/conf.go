...
type Conf struct {
	...
	CookieSameSitePolicy string        `mapstructure:"jwt-cookie-same-site" desc:"Define SameSite policy applied to token cookies"       default:"strict" allowed:"strict,lax,default,none"`
