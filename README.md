...
> Note: Learn more about [configuration files](#configuration-file) to save some time!
...
A configuration file is a YAML file containing certain parameters. Here is a quick example to
avoid passing `--api` and `--namespace` to all your a3sctl commands:
